...
2. [공식문서](https://utteranc.es/) 의 **configuration** 를 따른다.
    1. ![](https://doozi316.github.io/assets/images/Git5/1.png) 
        - issue 가 등록될 repository를 등록한다. 
        - 예) doozi316/doozi316.github.io
    2. ![](https://doozi316.github.io/assets/images/Git5/2.png)
        - issue와 블로그 포스팅의 매핑 방법을 설정한다. 
        - 제목, 경로, issue number, url 등으로 설정할 수 있다.
        - 나는 제목으로 설정해두었다.
    3. ![](https://doozi316.github.io/assets/images/Git5/3.png)
        - issue의 라벨을 설정할 수 있다.
        - 옵션이기 때문에 설정하지 않아도 된다.
        - 나는 `Comment` 로 해두었다.
    4. ![](https://doozi316.github.io/assets/images/Git5/4.png)
        - 위젯의 테마를 설정해 줄 수 있다.
        - 나는 블로그가 전체적으로 하얀색이여서 Light 테마로 설정했다.
    5. ![](https://doozi316.github.io/assets/images/Git5/5.png)
        - 설정을 다 해주고 나면 신기하게도 script 문이 자동 생성된다. 
        - 이 scrirpt 문을 복사한다.
    6. ![](https://doozi316.github.io/assets/images/Git5/6.png)
...
- 블로그 포스팅 하단에 댓글 위젯이 뜨는 걸 확인할 수 있다.
 ![](https://doozi316.github.io/assets/images/Git5/7.png)
- 댓글을 입력하면 블로그 repository 의 issue에 해당 댓글이 등록된다.
 ![](https://doozi316.github.io/assets/images/Git5/8.png)